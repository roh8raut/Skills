...
- Says "write a commit", "commit message", "generate commit", "/commit", or "/caveman-commit"
- Has staged changes and wants a compressed, no-noise commit message
- Says "stop caveman-commit" or "normal mode": revert to verbose commit style
...
Diff: simple one-liner fix

```
fix(auth): null-check token before decode
```
